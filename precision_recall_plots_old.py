...
def get_precisions_and_recalls():
    ...
    try:
        result = pd.read_csv("data/precision_recall_plot_2.csv")
        ...
        simList = [similarity.SimilarityFunctionType.COSINE_SIMILARITY]
                   #, similarity.SimilarityFunctionType.INNER_PRODUCT, similarity.SimilarityFunctionType.JACCARD]
        ...
        result.to_csv("data/precision_recall_plot_2.csv")
